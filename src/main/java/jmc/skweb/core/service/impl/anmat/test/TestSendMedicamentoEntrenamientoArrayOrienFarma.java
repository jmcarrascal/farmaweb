...
public class TestSendMedicamentoEntrenamientoArrayOrienFarma {
	...
	public static void main(String[] args) {
		...
		TestSendMedicamentoEntrenamientoArrayOrienFarma t = new TestSendMedicamentoEntrenamientoArrayOrienFarma();
		t.entrenar();
	}
...
//		//Debe informar un lote de 20 productos como robados / extraviados, a traves del WebService
	...
	public void sendMedicamento() {
		...
		try {
			...
			ss.setArg1("9991137700035");
			ss.setArg2("RURAL2012");
