...
public interface EmpresaManager {
	...
	boolean existeGln(String gln);

	void saveEmpresaWeb(EmpresaWeb empresaWeb);

	void updateEmpresa(EmpresaWeb empresaWeb);

	List<EmpresaWeb> getEmpresas();

	EmpresaWeb getEmpresaByPK(Integer idEmpresaWeb);
