 ...
 */
public class SendMedicamentosDHSerieImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.inssjp.mywebservice.business.SendMedicamentosDHSerie
{
    
    public SendMedicamentosDHSerieImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.inssjp.mywebservice.business.MedicamentosDTODHSerie[] getArg0Array()
    {
        synchronized (monitor())
        {
            ...
            com.inssjp.mywebservice.business.MedicamentosDTODHSerie[] result = new com.inssjp.mywebservice.business.MedicamentosDTODHSerie[targetList.size()];
     ...
     */
    public com.inssjp.mywebservice.business.MedicamentosDTODHSerie getArg0Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.inssjp.mywebservice.business.MedicamentosDTODHSerie target = null;
            target = (com.inssjp.mywebservice.business.MedicamentosDTODHSerie)get_store().find_element_user(ARG0$0, i);
            if (target == null)
            {
     ...
     */
    public void setArg0Array(com.inssjp.mywebservice.business.MedicamentosDTODHSerie[] arg0Array)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setArg0Array(int i, com.inssjp.mywebservice.business.MedicamentosDTODHSerie arg0)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.inssjp.mywebservice.business.MedicamentosDTODHSerie insertNewArg0(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.inssjp.mywebservice.business.MedicamentosDTODHSerie target = null;
            target = (com.inssjp.mywebservice.business.MedicamentosDTODHSerie)get_store().insert_element_user(ARG0$0, i);
            return target;
        }
    }
     ...
     */
    public com.inssjp.mywebservice.business.MedicamentosDTODHSerie addNewArg0()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.inssjp.mywebservice.business.MedicamentosDTODHSerie target = null;
            target = (com.inssjp.mywebservice.business.MedicamentosDTODHSerie)get_store().add_element_user(ARG0$0);
            return target;
        }
    }
