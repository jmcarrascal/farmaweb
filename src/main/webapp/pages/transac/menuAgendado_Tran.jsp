...
$(document).ready(function(){
		...
		$("#idRepoCCContinuarImage").click(function (){
			...
			if (validarCampos()){			
				...
				if ($("#idTipoReporteSelect").val() == 1 || $("#idTipoReporteSelect").val() == 3){				
					callReporte();					
				}
...
<div align="right"><a href="<%=request.getContextPath()%>/preparedFindAgendadoPorNombre_Tran"> <img
	...
	<div id="tabs-0">
				...
				<s:form	id="adminComprobForm" action="adminComprob_Tran" theme="simple" cssClass="inline" method="post">
					...
					<div align="right"><img	src="<%=request.getContextPath()%>/images/general/Paso1.png"  alt="Paso1" title="Paso1" border="0"></img></div>
					<div align="left">
					<table>
					<tr>
