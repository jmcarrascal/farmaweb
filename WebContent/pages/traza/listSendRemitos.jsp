...
<div class="main">
<div align="right"><a href="preparedListRemitosPendientes">  </a> <a href="<%=request.getContextPath()%>/home"> <img
	src="<%=request.getContextPath()%>/images/general/homev1.png" width="50px" alt="Inicio" title="Inicio"
	border="0"></img> </a>
	</div>
			
		   	<fieldset class="defaultFieldset">
    			<legend><b>Enviar trazabiliadad a ANMAT por Remito(SK) - Selección de Remito</b></legend>    			
	 			<table>					
				<tr>
					<td align="left">
...
<s:form action="viewTrazaEgreso" id="showMedicamentosForm">
